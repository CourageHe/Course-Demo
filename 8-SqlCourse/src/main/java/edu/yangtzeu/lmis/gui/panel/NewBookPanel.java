...
public class NewBookPanel extends JPanel {
	...
	public void initBookInfoPanel(){
		...
		bookInfoPanel.setBounds(0, -31, 435, 744);
		add(bookInfoPanel);
	...
	public void initFunctionPanel(){
		...
		functionPanel.setBounds(435, 0, 398, 713);
		add(functionPanel);
		functionPanel.setLayout(null);
		
		JLabel lblNewLabel = new JLabel("内容简介");
		lblNewLabel.setBounds(0, 0, 60, 18);
		functionPanel.add(lblNewLabel);
		
		JPanel panel_3 = new JPanel();
		panel_3.setBounds(0, 670, 398, 43);
		functionPanel.add(panel_3);
		panel_3.setLayout(null);
		
		btnAdd = new JButton("添加");
	
		btnAdd.setBounds(0, 0, 113, 27);
		panel_3.add(btnAdd);
		
		btnCancel = new JButton("取消");
	
		btnCancel.setBounds(137, 0, 113, 27);
		panel_3.add(btnCancel);
		
		btnReturn = new JButton("返回");
	
		btnReturn.setBounds(285, 0, 113, 27);
		panel_3.add(btnReturn);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(0, 51, 398, 540);
	...
	public void initcoverPanel(){
		...
		btnLoadPictureFile.setBounds(191, 640, 93, 27);
		coverPanel.add(btnLoadPictureFile);
		
		JLabel label_13 = new JLabel("封面");
		label_13.setBounds(2, 2, 60, 18);
	...
	public void initListener() {
		...
		btnLoadPictureFile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				int returnVal = fc.showOpenDialog(NewBookPanel.this);
